...
<body style="height:100%; background:none transparent;">
	<div class="container" style="max-width:610px; padding-top:50px">
		...
		<div id="step_learn1" class="step" style="display:inline; opacity:1">
			<p>
				<h4>Enrolling new user 1/2: Please type the text below</h4></p>
			<p><span id="pA1H" class="highlighted"></span><span id="pA1"></span></p>
			<br />
			<textarea rows="2" cols="100" class="form-control" id="enrolltext1" name="enrolltext1" onkeyup="highlight('pA1H','pA1', this)" placeholder="Type the text loaded above"></textarea>There's one ring to rule them all
			<br />
